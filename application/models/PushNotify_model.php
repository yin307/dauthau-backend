...
class PushNotify_model extends CI_Model implements PushNotify{
  ...
  public function scanContentPush(){
    ...
    //Phê duyệt đăng ký Nhà thầu!" - Chỉ đối với nhà thầu
      ...
      select \'TBL_BIDERS\' as NAME_TABLE,
            ...
            \'phe_duyet_dang_ky_nha_thau\' as "TYPE_PUSH",
            SYSDATE as DATE_CREATED,
            CONCAT(\'Số ĐKKD/MST: \',
  ...
  public function getUserPush($item){
    ...
    $arrCk = array(
      ...
      'tra_loi_lam_ro_ho_so_du_thau','bao_cao_danh_gia_ho_so_du_thau', 'phe_duyet_dang_ky_nha_thau'
    );
  ...
  public function sendMessage($include_player_ids,$content,$url,$headings='Mua Sắm Công'){
      ...
      "en" => $content
		...
		$fields = array(
			...
			'app_id' => "4ee24ae1-98e9-44c4-81e2-a3e365bef41e",
    ...
    // print($fields);
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json; charset=utf-8','Authorization: Basic NGM1NmRhODAtZWVlOC00OWFkLTgwM2ItYWNkMGExYTVkNDlj'));
